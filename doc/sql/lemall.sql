...
-- ----------------------------
INSERT INTO `ums_admin` VALUES (1958437596929527810, 'admin', '$2a$10$6DLfSkTw5LZl7aLlBVB6TOtYdg.xo6gqs3af5rRv/0gJ12EcPlRja', 1982782933978583041, '2910694449@qq.com', '超级管理员', '拥有系统最高权限', '2025-11-06 11:08:56', 1, '2025-10-24 16:46:30', '2025-11-06 11:08:56');
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1986269541738430466 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ums_role_menu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1986263299183816706 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台角色菜单关系表' ROW_FORMAT = DYNAMIC;
