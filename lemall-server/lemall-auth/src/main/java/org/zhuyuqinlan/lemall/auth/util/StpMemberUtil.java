package org.zhuyuqinlan.lemall.auth.util;
...
public class StpMemberUtil {
    public static final String TYPE = AuthConstant.STP_MEMBER_LOGIN_TYPE;
    public static StpLogic stpLogic = new StpLogic(AuthConstant.STP_MEMBER_LOGIN_TYPE);
