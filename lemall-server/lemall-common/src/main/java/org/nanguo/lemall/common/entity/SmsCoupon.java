...
public class SmsCoupon {
    ...
    /**
     * 获取优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券
     *
     * @return type - 优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券
     */
    ...
    /**
     * 设置优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券
     *
     * @param type 优惠券类型；0->全场赠券；1->会员赠券；2->购物赠券；3->注册赠券
     */
