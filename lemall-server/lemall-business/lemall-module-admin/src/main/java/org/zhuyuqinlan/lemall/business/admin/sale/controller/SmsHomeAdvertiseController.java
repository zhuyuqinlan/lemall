...
public class SmsHomeAdvertiseController {
    ...
    public Result<PageResult<SmsHomeAdvertiseDTO>> list(@RequestParam(value = "name", required = false) String name,
        ...
        return Result.success(PageResult.fromMybatis(advertiseList));
    }
}
